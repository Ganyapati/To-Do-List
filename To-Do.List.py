...
L1=Label(root, text='Welcome To Do List', bg='pink', font=("Times", 15), wraplength=300)
L1.place(x=70, y=10)
tasks = Listbox(root, selectbackground='Gold', bg='beige', font=('Helvetica', 12), height=12, width=25)
...
add_btn = Button(root, text='Add Item', bg='Azure', width=10, font=('Helvetica', 12),command=lambda: add_item(new, tasks))
